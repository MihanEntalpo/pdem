...
setup(
    ...
    version=pdem.__version__,

    description='process daemonizer client-server library',
    long_description=long_description + changes,

    # The project's main homepage.
    url='https://github.com/MihanEntalpo/pdem',
